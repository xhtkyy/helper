...
namespace Xhtkyy\Helper\BotMsg\src;
...
use Xhtkyy\Helper\BotMsg\BotMsgInterface;

class DingTalk implements BotMsgInterface
{
    ...
    public function info(string $title, mixed $content): static
    {
        $this->body = [
            'msgtype' => 'markdown',
            'markdown' => [
    ...
    public function error(string $title, mixed $content): static
    {
        $this->body = [
            'msgtype' => 'markdown',
            'markdown' => [
